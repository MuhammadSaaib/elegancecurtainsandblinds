...
export const Route = createFileRoute("/curtains")({
  ...
  component: () => (
    <CollectionPage
      ...
      image={curtainsImg}
      items={[
        { name: "Sheer Curtains", from: 490, estimateId: "pinch-pleat-sheers", desc: "Delicate day curtains in linen, voile & silk-blend. Diffuse harsh Dubai sun into a soft, luminous glow." },
        ...
        { name: "Roman Curtains", from: 418, estimateId: "sheer-roman-blinds", desc: "Tailored fold-down shades in sheer or blackout — perfect where drapes won't fit." },
