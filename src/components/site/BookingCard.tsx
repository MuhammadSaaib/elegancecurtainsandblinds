      ...
      {sent ? (
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Phone">
              <input required placeholder="+971" className={inputCls} />
            </Field>
          ...
          <p className="text-center text-[11px] text-muted-foreground">
            Or WhatsApp us on{" "}
            <a href={SITE.whatsapp} target="_blank" rel="noreferrer" className="text-primary underline underline-offset-2">
              {SITE.phone}
            </a>
          </p>
        </form>
...
function Select({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative">
      <select className={`${inputCls} appearance-none pr-9`}>{children}</select>
